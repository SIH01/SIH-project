...
const STATUSES = ["Historical", "Current", "Forecast"];
...
async function createDisaster(req, res) {
  const body = { ...req.body, latitude: parseFloat(req.body.latitude), longitude: parseFloat(req.body.longitude) };
